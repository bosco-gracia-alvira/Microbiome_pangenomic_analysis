...
dendro_plot <- ggplot() +
  ...
  theme(plot.margin = margin(1, 1, 1, 1)) +  # Add more space at the bottom
  labs(title = "Functional clustering of the isolates", y = "Binary distance", x = "Strain")

dendro_plot

# Save the plot using ggsave
ggsave(filename = "Lac_dendrogram.png", plot = dendro_plot, path = visuals_path, width = 20, height = 14, dpi = 300)
